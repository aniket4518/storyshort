        ...
        >
          ...
          <div className={`flex flex-row items-center transition-all duration-300 ${scrolled ? 'gap-1' : 'gap-2'}`}>
            ...
            <div className={`flex items-center transition-all duration-300 ${scrolled ? 'gap-0.5' : 'gap-1.5'}`}>
              <Link className="flex items-center justify-center text-sm leading-[110%] px-4 py-2 rounded-md text-black dark:text-white hover:bg-neutral-100 dark:hover:bg-black/40 transition duration-200" href="/pricing">
                Pricing
              </Link>
              <Link className="flex items-center justify-center text-sm leading-[110%] px-4 py-2 rounded-md text-black dark:text-white hover:bg-neutral-100 dark:hover:bg-black/40 transition duration-200" href="/blog">
                Blog
              </Link>
              <Link className="flex items-center justify-center text-sm leading-[110%] px-4 py-2 rounded-md text-black dark:text-white hover:bg-neutral-100 dark:hover:bg-black/40 transition duration-200" href="/affiliate">
