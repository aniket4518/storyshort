      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="inline-flex items-center gap-2 w-fit">
            ...
            <span className="text-yellow-500 font-medium text-sm">Powered by GPT-5</span>
          </div>

          {/* Heading */}
          <h1 className="text-6xl lg:text-7xl font-bold leading-tight text-black dark:text-white">
            Create <span className="text-yellow-400">viral</span>
            <br />
        ...
        <div className="relative w-full h-[600px] flex items-center justify-center">
          ...
          <div className="absolute left-0 top-1/2 -translate-y-1/2 w-[220px] h-[400px] rounded-2xl overflow-hidden shadow-2xl transform -rotate-0 z-5">
            <div className="relative w-full h-full bg-gradient-to-br from-amber-900 to-amber-700">
              <div className="absolute inset-0 flex items-end p-6">
                <div className="flex flex-col gap-2">
                  ...
                  <h3 className="text-white font-bold text-xl">The Cleopatre Effect</h3>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="absolute left-5/8 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[220px] h-[400px] rounded-2xl overflow-hidden shadow-2xl transform rotate-12 z-3">
            <div className="relative w-full h-full bg-gradient-to-br from-blue-400 to-blue-600">
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <p className="text-white text-sm font-medium">sadest story on sst</p>
              </div>
            </div>
          </div>
          ...
          <div className="absolute left-3/4 top-5/8 -translate-y-1/2 w-[220px] h-[400px] rounded-2xl overflow-hidden shadow-2xl transform rotate-26 z-2">
            <div className="relative w-full h-full bg-gradient-to-br from-orange-600 to-purple-900">
              <div className="absolute bottom-6 right-6">
                <p className="text-white text-sm font-medium text-right">
                  Day Apollo 11 landed on<br />
